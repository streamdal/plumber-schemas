...
func (m *NatsReadOpts) Reset()         { *m = NatsReadOpts{} }
func (m *NatsReadOpts) String() string { return proto.CompactTextString(m) }
func (*NatsReadOpts) ProtoMessage()    {}
func (*NatsReadOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_5cc83ab78dc78ae1, []int{1}
}

func (m *NatsReadOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NatsReadOpts.Unmarshal(m, b)
}
func (m *NatsReadOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NatsReadOpts.Marshal(b, m, deterministic)
}
func (m *NatsReadOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NatsReadOpts.Merge(m, src)
}
func (m *NatsReadOpts) XXX_Size() int {
	return xxx_messageInfo_NatsReadOpts.Size(m)
}
func (m *NatsReadOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_NatsReadOpts.DiscardUnknown(m)
}

var xxx_messageInfo_NatsReadOpts proto.InternalMessageInfo

func (m *NatsReadOpts) GetSubject() string {
	if m != nil {
		return m.Subject
	}
	return ""
...
func (m *NatsWriteOpts) Reset()         { *m = NatsWriteOpts{} }
func (m *NatsWriteOpts) String() string { return proto.CompactTextString(m) }
func (*NatsWriteOpts) ProtoMessage()    {}
func (*NatsWriteOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_5cc83ab78dc78ae1, []int{2}
}

func (m *NatsWriteOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NatsWriteOpts.Unmarshal(m, b)
}
func (m *NatsWriteOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NatsWriteOpts.Marshal(b, m, deterministic)
}
func (m *NatsWriteOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NatsWriteOpts.Merge(m, src)
}
func (m *NatsWriteOpts) XXX_Size() int {
	return xxx_messageInfo_NatsWriteOpts.Size(m)
}
func (m *NatsWriteOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_NatsWriteOpts.DiscardUnknown(m)
}

var xxx_messageInfo_NatsWriteOpts proto.InternalMessageInfo

func (m *NatsWriteOpts) GetSubject() string {
	if m != nil {
		return m.Subject
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*NatsReadOpts)(nil), "protos.args.NatsReadOpts")
	proto.RegisterType((*NatsWriteOpts)(nil), "protos.args.NatsWriteOpts")
}
...
var fileDescriptor_5cc83ab78dc78ae1 = []byte{
	...
	0x1d, 0x68, 0x06, 0x26, 0xc4, 0x46, 0x46, 0x24, 0x90, 0x22, 0x24, 0x24, 0x96, 0xc8, 0x71, 0x4e,
	0x6d, 0xc0, 0xb5, 0x23, 0xdf, 0x79, 0xe8, 0x3f, 0xe5, 0xe7, 0x20, 0xbb, 0x14, 0x98, 0x98, 0xec,
	0x7b, 0xef, 0x59, 0xee, 0x05, 0x30, 0x92, 0x69, 0xdd, 0x3b, 0xcb, 0x56, 0x4c, 0xe2, 0x43, 0x6b,
	0xe9, 0x36, 0xb4, 0xfc, 0x48, 0x60, 0xf4, 0x28, 0x99, 0x4a, 0x6b, 0x8c, 0x98, 0xc3, 0xa0, 0x25,
	0x93, 0x25, 0x8b, 0x24, 0x1f, 0x57, 0xe1, 0x2b, 0x2e, 0x20, 0xed, 0x0c, 0xa1, 0xf2, 0x0e, 0x6b,
	...
	,
}
