...
type NatsJetstreamReadArgs struct {
	...
	UseDurableConsumer bool `protobuf:"varint,2,opt,name=use_durable_consumer,json=useDurableConsumer,proto3" json:"use_durable_consumer,omitempty" kong:"help='Whether to use a durable consumer (default: use ephemeral consumer)',env='PLUMBER_RELAY_NATS_JETSTREAM_USE_DURABLE_CONSUMER'"`
	// @gotags: kong:"help='Consumer name (default: random consumer name)',env='PLUMBER_RELAY_NATS_JETSTREAM_CONSUMER_NAME'"
	ConsumerName string `protobuf:"bytes,3,opt,name=consumer_name,json=consumerName,proto3" json:"consumer_name,omitempty" kong:"help='Consumer name (default: random consumer name)',env='PLUMBER_RELAY_NATS_JETSTREAM_CONSUMER_NAME'"`
	...
	KeepConsumer bool `protobuf:"varint,4,opt,name=keep_consumer,json=keepConsumer,proto3" json:"keep_consumer,omitempty" kong:"help='Do not delete consumer config after read operation is done (default: delete on exit)',env='PLUMBER_RELAY_NATS_JETSTREAM_KEEP_CONSUMER'"`
	...
	ConsumerStartSequence int64 `protobuf:"varint,5,opt,name=consumer_start_sequence,json=consumerStartSequence,proto3" json:"consumer_start_sequence,omitempty" kong:"help='Where to start read in stream (default: from start)',env='PLUMBER_RELAY_NATS_JETSTREAM_CONSUMER_START_SEQUENCE'"`
	...
	ConsumerStartTime string `protobuf:"bytes,6,opt,name=consumer_start_time,json=consumerStartTime,proto3" json:"consumer_start_time,omitempty" kong:"help='At what time to start stream (RFC3339 format, Ex: 2016-06-20T12:41:45.14Z)',env='PLUMBER_RELAY_NATS_JETSTREAM_CONSUMER_START_TIME'"`
	...
	ConsumerFilterSubject string   `protobuf:"bytes,7,opt,name=consumer_filter_subject,json=consumerFilterSubject,proto3" json:"consumer_filter_subject,omitempty" kong:"help='Only receive a subset of messages from the Stream based on the subject',env='PLUMBER_RELAY_NATS_JETSTREAM_CONSUMER_FILTER_SUBJECT'"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}
...
func (m *NatsJetstreamReadArgs) GetUseDurableConsumer() bool {
	if m != nil {
		return m.UseDurableConsumer
	}
	return false
}
...
var fileDescriptor_a1868c7e9e1b078c = []byte{
	...
	,
}
