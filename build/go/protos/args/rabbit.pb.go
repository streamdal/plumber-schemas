...
func (m *RabbitReadOpts) Reset()         { *m = RabbitReadOpts{} }
func (m *RabbitReadOpts) String() string { return proto.CompactTextString(m) }
func (*RabbitReadOpts) ProtoMessage()    {}
func (*RabbitReadOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a3e2cf5cfff1350, []int{1}
}

func (m *RabbitReadOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RabbitReadOpts.Unmarshal(m, b)
}
func (m *RabbitReadOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RabbitReadOpts.Marshal(b, m, deterministic)
}
func (m *RabbitReadOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RabbitReadOpts.Merge(m, src)
}
func (m *RabbitReadOpts) XXX_Size() int {
	return xxx_messageInfo_RabbitReadOpts.Size(m)
}
func (m *RabbitReadOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_RabbitReadOpts.DiscardUnknown(m)
}

var xxx_messageInfo_RabbitReadOpts proto.InternalMessageInfo

func (m *RabbitReadOpts) GetExchangeName() string {
	if m != nil {
...
func (m *RabbitReadOpts) GetQueueName() string {
	if m != nil {
		return m.QueueName
	}
	return ""
...
func (m *RabbitReadOpts) GetBindingKey() string {
	if m != nil {
		return m.BindingKey
	}
	return ""
...
func (m *RabbitReadOpts) GetQueueExclusive() bool {
	if m != nil {
...
func (m *RabbitReadOpts) GetQueueDeclare() bool {
	if m != nil {
...
func (m *RabbitReadOpts) GetQueueDurable() bool {
	if m != nil {
...
func (m *RabbitReadOpts) GetAutoAck() bool {
	if m != nil {
		return m.AutoAck
	}
	return false
...
func (m *RabbitReadOpts) GetConsumerTag() string {
	if m != nil {
...
func (m *RabbitReadOpts) GetQueueDelete() bool {
	if m != nil {
...
func (m *RabbitWriteOpts) Reset()         { *m = RabbitWriteOpts{} }
func (m *RabbitWriteOpts) String() string { return proto.CompactTextString(m) }
func (*RabbitWriteOpts) ProtoMessage()    {}
func (*RabbitWriteOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a3e2cf5cfff1350, []int{2}
}

func (m *RabbitWriteOpts) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RabbitWriteOpts.Unmarshal(m, b)
}
func (m *RabbitWriteOpts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RabbitWriteOpts.Marshal(b, m, deterministic)
}
func (m *RabbitWriteOpts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RabbitWriteOpts.Merge(m, src)
}
func (m *RabbitWriteOpts) XXX_Size() int {
	return xxx_messageInfo_RabbitWriteOpts.Size(m)
}
func (m *RabbitWriteOpts) XXX_DiscardUnknown() {
	xxx_messageInfo_RabbitWriteOpts.DiscardUnknown(m)
}

var xxx_messageInfo_RabbitWriteOpts proto.InternalMessageInfo

func (m *RabbitWriteOpts) GetExchangeName() string {
	if m != nil {
		return m.ExchangeName
	}
	return ""
...
func (m *RabbitWriteOpts) GetRoutingKey() string {
	if m != nil {
		return m.RoutingKey
	}
	return ""
...
func (m *RabbitWriteOpts) GetAppId() string {
	if m != nil {
		return m.AppId
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RabbitReadOpts)(nil), "protos.args.RabbitReadOpts")
	proto.RegisterType((*RabbitWriteOpts)(nil), "protos.args.RabbitWriteOpts")
}
...
var fileDescriptor_9a3e2cf5cfff1350 = []byte{
	...
	,
}
