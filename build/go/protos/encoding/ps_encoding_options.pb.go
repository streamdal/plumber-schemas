...
type ThriftSettings struct {
	...
	StructName           string   `protobuf:"bytes,2,opt,name=struct_name,json=structName,proto3" json:"struct_name,omitempty" kong:"help='Namespace and struct name to decode the message with. Ex: com.mycompany.Account'"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ThriftSettings) GetStructName() string {
	if m != nil {
		return m.StructName
	}
	return ""
...
var fileDescriptor_b8f6b0c5cf15b9fa = []byte{
	...
	,
}
