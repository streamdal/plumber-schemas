...
proto.protos.GetAllRelaysResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    opts_ps_opts_relay_pb.RelayOptions.toObject, includeInstance)
  };
...
proto.protos.GetAllRelaysResponse.prototype.getOptsList = function() {
  return /** @type{!Array<!proto.protos.opts.RelayOptions>} */ (
    jspb.Message.getRepeatedWrapperField(this, opts_ps_opts_relay_pb.RelayOptions, 1));
};
...
proto.protos.GetRelayResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    status: (f = msg.getStatus()) && common_ps_common_status_pb.Status.toObject(includeInstance, f),
    opts: (f = msg.getOpts()) && opts_ps_opts_relay_pb.RelayOptions.toObject(includeInstance, f)
  };
...
proto.protos.GetRelayResponse.prototype.getOpts = function() {
  return /** @type{?proto.protos.opts.RelayOptions} */ (
    jspb.Message.getWrapperField(this, opts_ps_opts_relay_pb.RelayOptions, 1));
};
...
proto.protos.UpdateRelayRequest.prototype.getOpts = function() {
  return /** @type{?proto.protos.opts.RelayOptions} */ (
    jspb.Message.getWrapperField(this, opts_ps_opts_relay_pb.RelayOptions, 2));
};
