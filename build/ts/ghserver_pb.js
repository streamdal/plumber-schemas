 ...
 * @const
 */
proto.protos.GithubEvent.oneofGroups_ = [[100,101,102,103,104,105,106]];
...
/**
 * optional NewJwtToken new_jwt_token = 106;
...
proto.protos.GithubEvent.prototype.getNewJwtToken = function() {
  return /** @type{?proto.protos.NewJwtToken} */ (
    jspb.Message.getWrapperField(this, proto.protos.NewJwtToken, 106));
};
...
proto.protos.GithubEvent.prototype.setNewJwtToken = function(value) {
  return jspb.Message.setOneofWrapperField(this, 106, proto.protos.GithubEvent.oneofGroups_[0], value);
};
