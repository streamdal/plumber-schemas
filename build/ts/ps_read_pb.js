...
proto.protos.CreateReadRequest.prototype.getRead = function() {
  return /** @type{?proto.protos.opts.ReadOptions} */ (
    jspb.Message.getWrapperField(this, opts_ps_opts_read_pb.ReadOptions, 1));
};
...
proto.protos.StartReadResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    records_ps_records_base_pb.ReadRecord.toObject, includeInstance),
    status: (f = msg.getStatus()) && common_ps_common_status_pb.Status.toObject(includeInstance, f)
  };
...
proto.protos.StartReadResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new records_ps_records_base_pb.ReadRecord;
      reader.readMessage(value,records_ps_records_base_pb.ReadRecord.deserializeBinaryFromReader);
...
proto.protos.StartReadResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      records_ps_records_base_pb.ReadRecord.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f != null) {
...
proto.protos.StartReadResponse.prototype.getRecordsList = function() {
  return /** @type{!Array<!proto.protos.records.ReadRecord>} */ (
    jspb.Message.getRepeatedWrapperField(this, records_ps_records_base_pb.ReadRecord, 1));
};
...
proto.protos.GetAllReadsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    opts_ps_opts_read_pb.ReadOptions.toObject, includeInstance),
    status: (f = msg.getStatus()) && common_ps_common_status_pb.Status.toObject(includeInstance, f)
  };
...
proto.protos.GetAllReadsResponse.prototype.getReadList = function() {
  return /** @type{!Array<!proto.protos.opts.ReadOptions>} */ (
    jspb.Message.getRepeatedWrapperField(this, opts_ps_opts_read_pb.ReadOptions, 1));
};
