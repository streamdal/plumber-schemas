...
goog.exportSymbol('proto.protos.WriteRecord.RecordsCase', null, global);
...
proto.protos.WriteRecord = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.protos.WriteRecord.oneofGroups_);
};
...
proto.protos.WriteRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, 500, proto.protos.WriteRequest.repeatedFields_, null);
};
 ...
 * @const
 */
proto.protos.WriteRecord.oneofGroups_ = [[100]];

/**
 * @enum {number}
 */
proto.protos.WriteRecord.RecordsCase = {
  RECORDS_NOT_SET: 0,
  KAFKA: 100
};

/**
 * @return {proto.protos.WriteRecord.RecordsCase}
 */
proto.protos.WriteRecord.prototype.getRecordsCase = function() {
  return /** @type {proto.protos.WriteRecord.RecordsCase} */(jspb.Message.computeOneofCase(this, proto.protos.WriteRecord.oneofGroups_[0]));
};
...
/**
 * optional records.Kafka kafka = 100;
 * @return {?proto.protos.records.Kafka}
 */
proto.protos.WriteRecord.prototype.getKafka = function() {
...
*/
proto.protos.WriteRecord.prototype.setKafka = function(value) {
  return jspb.Message.setOneofWrapperField(this, 100, proto.protos.WriteRecord.oneofGroups_[0], value);
};
 ...
 * @return {!proto.protos.WriteRecord} returns this
 */
proto.protos.WriteRecord.prototype.clearKafka = function() {
 ...
 * @return {boolean}
 */
proto.protos.WriteRecord.prototype.hasKafka = function() {
 ...
 * @return {string}
 */
proto.protos.WriteRequest.prototype.getConnectionId = function() {
 ...
 * @return {!proto.protos.WriteRequest} returns this
 */
proto.protos.WriteRequest.prototype.setConnectionId = function(value) {
...
proto.protos.WriteRequest.prototype.getRecordsList = function() {
  return /** @type{!Array<!proto.protos.WriteRecord>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.protos.WriteRecord, 2));
};
...
proto.protos.WriteRequest.prototype.addRecords = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.protos.WriteRecord, opt_index);
};
 ...
 * @return {!proto.protos.WriteRequest} returns this
 */
proto.protos.WriteRequest.prototype.clearRecordsList = function() {
 ...
 * @return {!proto.protos.WriteRequest} returns this
 */
proto.protos.WriteRequest.prototype.clearEncodeOptions = function() {
