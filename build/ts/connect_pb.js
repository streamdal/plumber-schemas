...
var opts_connection_pb = require('./opts/connection_pb.js');
goog.object.extend(proto, opts_connection_pb);
...
proto.protos.GetAllConnectionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    opts_connection_pb.ConnectionOptions.toObject, includeInstance)
  };
...
proto.protos.GetAllConnectionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new opts_connection_pb.ConnectionOptions;
      reader.readMessage(value,opts_connection_pb.ConnectionOptions.deserializeBinaryFromReader);
...
proto.protos.GetAllConnectionsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      opts_connection_pb.ConnectionOptions.serializeBinaryToWriter
    );
  }
};
...
proto.protos.GetAllConnectionsResponse.prototype.getOptionsList = function() {
  return /** @type{!Array<!proto.protos.opts.ConnectionOptions>} */ (
    jspb.Message.getRepeatedWrapperField(this, opts_connection_pb.ConnectionOptions, 1));
};
...
proto.protos.GetConnectionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    options: (f = msg.getOptions()) && opts_connection_pb.ConnectionOptions.toObject(includeInstance, f)
  };
...
proto.protos.GetConnectionResponse.prototype.getOptions = function() {
  return /** @type{?proto.protos.opts.ConnectionOptions} */ (
    jspb.Message.getWrapperField(this, opts_connection_pb.ConnectionOptions, 1));
};
...
proto.protos.UpdateConnectionRequest.prototype.getOptions = function() {
  return /** @type{?proto.protos.opts.ConnectionOptions} */ (
    jspb.Message.getWrapperField(this, opts_connection_pb.ConnectionOptions, 2));
};
