...
var records_ps_records_kafka_pb = require('../records/ps_records_kafka_pb.js');
goog.object.extend(proto, records_ps_records_kafka_pb);
...
proto.protos.records.ReadRecord.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    kafka: (f = msg.getKafka()) && records_ps_records_kafka_pb.Kafka.toObject(includeInstance, f),
...
proto.protos.records.ReadRecord.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 99:
      ...
      break;
    case 100:
      var value = new records_ps_records_kafka_pb.Kafka;
      reader.readMessage(value,records_ps_records_kafka_pb.Kafka.deserializeBinaryFromReader);
      msg.setKafka(value);
      break;
    case 1000:
      var value = /** @type {!Uint8Array} */ (reader.readBytes());
...
proto.protos.records.ReadRecord.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      100,
      f,
      records_ps_records_kafka_pb.Kafka.serializeBinaryToWriter
    );
  }
...
proto.protos.records.ReadRecord.prototype.getKafka = function() {
  return /** @type{?proto.protos.records.Kafka} */ (
    jspb.Message.getWrapperField(this, records_ps_records_kafka_pb.Kafka, 100));
};
