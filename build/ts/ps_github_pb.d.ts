...
export class StartGithubAuthRequest extends jspb.Message { 
    ...
    setAuth(value?: common_ps_common_auth_pb.Auth): StartGithubAuthRequest;
...
export class PollGithubAuthRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): PollGithubAuthRequest;
...
export class IsGithubAuthRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): IsGithubAuthRequest;
...
export class GetGithubEventsRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): GetGithubEventsRequest;
