...
proto.protos.opts.RelayGroupKafkaOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    args: (f = msg.getArgs()) && args_ps_args_kafka_pb.KafkaRelayArgs.toObject(includeInstance, f)
  };
...
proto.protos.opts.RelayGroupKafkaOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new args_ps_args_kafka_pb.KafkaRelayArgs;
      reader.readMessage(value,args_ps_args_kafka_pb.KafkaRelayArgs.deserializeBinaryFromReader);
      msg.setArgs(value);
      break;
    default:
      reader.skipField();
...
proto.protos.opts.RelayGroupKafkaOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      args_ps_args_kafka_pb.KafkaRelayArgs.serializeBinaryToWriter
    );
  }
};
...
proto.protos.opts.RelayGroupKafkaOptions.prototype.getArgs = function() {
  return /** @type{?proto.protos.args.KafkaRelayArgs} */ (
    jspb.Message.getWrapperField(this, args_ps_args_kafka_pb.KafkaRelayArgs, 2));
};
...
proto.protos.opts.RelayGroupAWSSQSOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    args: (f = msg.getArgs()) && args_ps_args_aws_sqs_pb.AWSSQSRelayArgs.toObject(includeInstance, f)
  };
...
proto.protos.opts.RelayGroupAWSSQSOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new args_ps_args_aws_sqs_pb.AWSSQSRelayArgs;
      reader.readMessage(value,args_ps_args_aws_sqs_pb.AWSSQSRelayArgs.deserializeBinaryFromReader);
      msg.setArgs(value);
      break;
    default:
      reader.skipField();
...
proto.protos.opts.RelayGroupAWSSQSOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      args_ps_args_aws_sqs_pb.AWSSQSRelayArgs.serializeBinaryToWriter
    );
  }
};
...
proto.protos.opts.RelayGroupAWSSQSOptions.prototype.getArgs = function() {
  return /** @type{?proto.protos.args.AWSSQSRelayArgs} */ (
    jspb.Message.getWrapperField(this, args_ps_args_aws_sqs_pb.AWSSQSRelayArgs, 2));
};
