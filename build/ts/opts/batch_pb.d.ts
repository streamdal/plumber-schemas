...
export class BatchCreateDestinationOptions extends jspb.Message { 
    ...
    hasKafka(): boolean;
    clearKafka(): void;
    getKafka(): opts_write_pb.WriteGroupKafkaOptions | undefined;
    setKafka(value?: opts_write_pb.WriteGroupKafkaOptions): BatchCreateDestinationOptions;

    hasRabbit(): boolean;
    clearRabbit(): void;
    getRabbit(): opts_write_pb.WriteGroupRabbitOptions | undefined;
    setRabbit(value?: opts_write_pb.WriteGroupRabbitOptions): BatchCreateDestinationOptions;

    hasKubemqQueue(): boolean;
    clearKubemqQueue(): void;
    getKubemqQueue(): opts_write_pb.WriteGroupKubeMQQueueOptions | undefined;
    setKubemqQueue(value?: opts_write_pb.WriteGroupKubeMQQueueOptions): BatchCreateDestinationOptions;

    hasAwssqs(): boolean;
    clearAwssqs(): void;
    getAwssqs(): opts_write_pb.WriteGroupAWSSQSOptions | undefined;
    setAwssqs(value?: opts_write_pb.WriteGroupAWSSQSOptions): BatchCreateDestinationOptions;
...
export namespace BatchCreateDestinationOptions {
    export type AsObject = {
        ...
        awssqs?: opts_write_pb.WriteGroupAWSSQSOptions.AsObject,
