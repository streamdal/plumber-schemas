...
import * as opts_ps_opts_connection_pb from "./opts/ps_opts_connection_pb";
...
export class GetAllConnectionsRequest extends jspb.Message { 
    ...
    setAuth(value?: common_ps_common_auth_pb.Auth): GetAllConnectionsRequest;
...
export class GetAllConnectionsResponse extends jspb.Message { 
    ...
    getOptionsList(): Array<opts_ps_opts_connection_pb.ConnectionOptions>;
    setOptionsList(value: Array<opts_ps_opts_connection_pb.ConnectionOptions>): GetAllConnectionsResponse;
    addOptions(value?: opts_ps_opts_connection_pb.ConnectionOptions, index?: number): opts_ps_opts_connection_pb.ConnectionOptions;
...
export namespace GetAllConnectionsResponse {
    export type AsObject = {
        optionsList: Array<opts_ps_opts_connection_pb.ConnectionOptions.AsObject>,
    }
}
...
export class GetConnectionRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): GetConnectionRequest;
...
export class GetConnectionResponse extends jspb.Message { 
    ...
    hasOptions(): boolean;
    clearOptions(): void;
    getOptions(): opts_ps_opts_connection_pb.ConnectionOptions | undefined;
    setOptions(value?: opts_ps_opts_connection_pb.ConnectionOptions): GetConnectionResponse;
...
export namespace GetConnectionResponse {
    export type AsObject = {
        options?: opts_ps_opts_connection_pb.ConnectionOptions.AsObject,
    }
}
...
export class CreateConnectionRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): CreateConnectionRequest;

    hasOptions(): boolean;
    clearOptions(): void;
    getOptions(): opts_ps_opts_connection_pb.ConnectionOptions | undefined;
    setOptions(value?: opts_ps_opts_connection_pb.ConnectionOptions): CreateConnectionRequest;
...
export class TestConnectionRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): TestConnectionRequest;

    hasOptions(): boolean;
    clearOptions(): void;
    getOptions(): opts_ps_opts_connection_pb.ConnectionOptions | undefined;
    setOptions(value?: opts_ps_opts_connection_pb.ConnectionOptions): TestConnectionRequest;
...
export class TestConnectionResponse extends jspb.Message { 
    ...
    setStatus(value?: common_ps_common_status_pb.Status): TestConnectionResponse;
...
export class UpdateConnectionRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): UpdateConnectionRequest;
    getConnectionId(): string;
    ...
    clearOptions(): void;
    getOptions(): opts_ps_opts_connection_pb.ConnectionOptions | undefined;
    setOptions(value?: opts_ps_opts_connection_pb.ConnectionOptions): UpdateConnectionRequest;
...
export class UpdateConnectionResponse extends jspb.Message { 
    ...
    clearStatus(): void;
    getStatus(): common_ps_common_status_pb.Status | undefined;
    setStatus(value?: common_ps_common_status_pb.Status): UpdateConnectionResponse;
...
export class DeleteConnectionRequest extends jspb.Message { 
    ...
    clearAuth(): void;
    getAuth(): common_ps_common_auth_pb.Auth | undefined;
    setAuth(value?: common_ps_common_auth_pb.Auth): DeleteConnectionRequest;
    getConnectionId(): string;
...
export class DeleteConnectionResponse extends jspb.Message { 
    ...
    clearStatus(): void;
    getStatus(): common_ps_common_status_pb.Status | undefined;
    setStatus(value?: common_ps_common_status_pb.Status): DeleteConnectionResponse;
