...
impl ::std::default::Default for Mongo {
  fn default() -> Self {
    Mongo {
...
lazy_static! {
  pub static ref Mongo_default: Mongo = Mongo::default();
}
impl ::pb_jelly::Message for Mongo {
  fn descriptor(&self) -> ::std::option::Option<::pb_jelly::MessageDescriptor> {
    Some(::pb_jelly::MessageDescriptor {
      name: "Mongo",
      full_name: "protos.records.Mongo",
      fields: &[
        ::pb_jelly::FieldDescriptor {
          name: "value",
          full_name: "protos.records.Mongo.value",
          index: 0,
          number: 1,
        ...
        ::pb_jelly::FieldDescriptor {
          name: "timestamp",
          full_name: "protos.records.Mongo.timestamp",
          index: 1,
          number: 2,
  ...
  fn deserialize<B: ::pb_jelly::PbBufferReader>(&mut self, mut buf: &mut B) -> ::std::io::Result<()> {
    while let Some((field_number, typ)) = ::pb_jelly::wire_format::read(&mut buf)? {
      match field_number {
        1 => {
          ::pb_jelly::ensure_wire_format(typ, ::pb_jelly::wire_format::Type::LengthDelimited, "Mongo", 1)?;
        ...
        2 => {
          ::pb_jelly::ensure_wire_format(typ, ::pb_jelly::wire_format::Type::Varint, "Mongo", 2)?;
...
impl ::pb_jelly::Reflection for Mongo {
