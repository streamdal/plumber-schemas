...
local:
	cp -R $(GO_PROTOS_DIR)/ ~/Code/plumber/vendor/github.com/streamdal/plumber-schemas/$(GO_PROTOS_DIR)/
#	cp -R $(GO_PROTOS_DIR)/ ~/Code/foreman/vendor/github.com/streamdal/plumber-schemas/$(GO_PROTOS_DIR)/
#	cp -R $(GO_PROTOS_DIR)/ ~/Code/ui-bff/vendor/github.com/streamdal/plumber-schemas/$(GO_PROTOS_DIR)/
